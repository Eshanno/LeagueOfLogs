...
class Bootstrap(object):
    ...
    def load_css(version='4.3.1'):
        ...
        if serve_local:
            css = '<link rel="stylesheet" href="%s" type="text/css">\n' % \
                  url_for('bootstrap.static', filename='bootstrap-4.3.1/dist/css/' + css_filename)
        else:
    ...
    @staticmethod
    def load_js(version='4.3.1', jquery_version='3.3.1', popper_version='1.14.7', with_jquery=True, with_popper=True):
        ...
        if serve_local:
            js = '<script src="%s"></script>' % url_for('bootstrap.static', filename='bootstrap-4.3.1/dist/js/' + js_filename)
        else:
